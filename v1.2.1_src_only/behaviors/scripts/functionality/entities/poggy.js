    ...
    for (let i = 0; i < players.length; i++) {
        ...
        switch (variant) {
            case 0:
                ...
                entity.applyKnockback({ x: 0, z: 0 }, -3.5);
            break;
            case 4: entity.applyKnockback({ x: 0, z: 0 }, -0.3); break;
        };
    };
}, 32);
...
export function poggy(player) {
    ...
    const variant = entity.getComponent(EntityVariantComponent.componentId)?.value;
    switch (variant) {
        case 3: entity.applyKnockback({ x: 0, z: 0 }, 0.16); break;
        case 4: entity.applyKnockback({ x: 0, z: 0 }, -0.3); break;
        case 11: {
        ...
        case 12: {
            entity.applyKnockback({ x: 0, z: 0 }, -0.3);
